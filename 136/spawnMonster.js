...
function EncodeTemporary() {
  ...
  addMonsterInformation()
    ...
    //     mobstat.put(buff.getStati(), buff.getMobSkill());
    ...
    // for (MonsterStatus stat : mobstat.keySet()) {
    //     if (stat == MonsterStatus.WDEF) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.MDEF) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.BLIND) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.SEAL_SKILL) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.BLIND || stat == MonsterStatus.SEAL_SKILL) {
    //         mplew.writeInt(0);
    //         mplew.write(0);//131新
    //         mplew.writeInt(0);
    //     }
    //     if (stat == MonsterStatus.HEAL_DAMAGE) {
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //     }
    //     if (stat == MonsterStatus.MBS70) {
    //         int result = 0;
    //         mplew.write(result);
    //         if (result != 0) {
    //             mplew.writeInt(0);
    ...
    //         }
    //     }
    //     if (stat == MonsterStatus.MBS39) {
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //     }
    //     if (stat == MonsterStatus.MBS42) {
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //     }
    //     if (stat == MonsterStatus.SPEED) {
    //         mplew.write(0);
    //     }
    //     if (stat == MonsterStatus.MBS51) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.MBS54) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.MBS56) {
    //         mplew.writeShort(mobstat.get(stat).getEffectDelay());
    //         mplew.writeShort(0);
    //     }
    //     if (stat == MonsterStatus.BLEED) {
    //         List<MonsterStatusEffect> mses = new ArrayList<>();
    //         for (MonsterStatusEffect eff : buffs) {
    //             if (eff.getStati() == MonsterStatus.BLEED) {
    //                 if (eff.getSkill() <= 0) {
    //                     continue;
    //                 }
    //                 mses.add(eff);
    ...
    //         }
    //         int v23 = 0;
    //         mplew.write(mses.size());
    //         if (mses.size() > 0) {
    //             do {
    //                 Skill skill = SkillFactory.getSkill(mses.get(v23).getSkill());
    //                 MapleStatEffect eff = skill.getEffect(skill.getFixLevel());
    //                 mplew.writeInt(mses.get(v23).getFromID());//人物id
    //                 mplew.writeInt(mses.get(v23).getSkill()); // 技能ID
    //                 mplew.writeInt(mses.get(v23).getX());// 伤害数值
    //                 mplew.writeInt(1000); // 延遲毫秒 : dotInterval * 1000
    //                 mplew.writeInt(0);// 结束时间
    //                 if (mses.get(v23).getSkill() > 0) {
    ...
    //                 mplew.writeInt(0);//DotTickDamR
    //                 mplew.writeInt(mons.getController().getSkillLevel(mses.get(v23).getSkill()));
    //                 mplew.writeInt(mses.get(v23).getX());
    //                 ++v23;
    //             } while (v23 < mses.size());
    //         }
    //     }
    //     if (stat == MonsterStatus.MBS68) {
    //         mplew.write(0);
    //         mplew.write(0);
    //     }
    //     if (stat == MonsterStatus.MBS69) {
    //         mplew.write(0);
    //     }
    //     if (stat == MonsterStatus.MONSTER_BOMB) {
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //     }
    //     if (stat == MonsterStatus.MBS71) {
    //         mplew.writeMapleAsciiString("");
    //     }
    //     if (stat == MonsterStatus.MBS72) {
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //     }
    //     if (stat == MonsterStatus.MBS73) {
    //         mplew.writeInt(0);
    //         mplew.writeInt(0);
    //         mplew.writeShort(0);
    //         mplew.writeInt(0);
