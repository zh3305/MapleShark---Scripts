...
v4 = Check_Buff (mask, 0x22B8C18);
  ...
  v2596 = Check_Buff (mask, 0x22BAE68);
  if ( sub_42CEB0 (v2596))
  {
     mplew.StartNode("Mask - " + map.get(0x22BAE68));
    for ( j = 0; j < 22; ++j )
  ...
  v2699 = Check_Buff (mask, 0x22BEE88);
  if ( sub_42CEB0 (v2699))
  {
     mplew.StartNode("Mask - " + map.get(0x22BEE88));
...
mplew.EndNode(false); //SecondaryStat::DecodeForLocal
// }
...
//BOOL __cdecl sub_E60680 (/* char a1 */)
{
  ...
  {
    dword_22D4C4C = 1;
  value1=( Check_Buff(mask, 0x22D4FF4)
